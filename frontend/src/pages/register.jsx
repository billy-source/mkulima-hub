...
function Register() { 
    ...
    return ( 
        ...
        <div className='relative flex items-center justify-center min-h-screen py-20 
bg-cover bg-center' style={{backgroundImage: "url(/assets/Images/home.jpg)"}}>
            <div className="absolute inset-0 bg-black opacity-50"></div> 
            
            {/* Removed mt-36 class */}
            <form onSubmit={handleSubmit} className="z-10 w-full max-w-md 
mx-auto bg-white p-8 rounded-lg shadow-lg"> 
                {/* Close/Cancel Button */}
